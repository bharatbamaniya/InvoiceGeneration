...
pattern = r"fun createPdfInvoice.*?return pdfFile\n        \} catch \(e: Exception\) \{\n            e\.printStackTrace\(\)\n            pdfDocument\.close\(\)\n            null\n        \}\n    \}"
...
new_pdf = """fun createPdfInvoice(context: Context, invoice: Invoice): File? {
        ...
        val containerRect = android.graphics.RectF(40f, 40f, pageWidth - 40f, totalHeight - 40f)
...
text = re.sub(pattern, new_pdf, text, flags=re.DOTALL)
