            ...
            when (currentScreen) {
                ...
                AppScreen.CUSTOMER_DETAIL -> {
                    ...
                    if (customer != null) {
                        CustomerDetailScreen(
                            ...
                            onNewInvoice = { currentScreen = AppScreen.CHECKOUT },
                ...
                AppScreen.CHECKOUT -> {
                    CheckoutScreen(
                        ...
                        onUpdateStoreSettings = { name, address, phone, owner, symbol -> viewModel.updateStoreSettings(name, address, phone, owner, symbol, uiState.swipeToDeleteEnabled) },
                        onGenerateInvoice = {
