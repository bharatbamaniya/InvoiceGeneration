...
if start_idx != -1 and end_idx != -1:
    new_pdf = """fun createPdfInvoice(context: Context, invoice: Invoice): File? {
        ...
        if (invoice.customerPhone.isNotBlank()) {
            canvas.drawText(invoice.customerPhone, startX, y, addressPaint.apply { textAlign = Paint.Align.LEFT })
        }
        y += 20f
        ...
        val summaryValuePaint = Paint(tableItemPaint).apply { typeface = sansSerifBold }
        
        val summaryX = colRateX - 10f
        ...
        y += 10f
        val boxHeight = 40f
        val boxRect = android.graphics.RectF(summaryX - 10f, y, endX + 10f, y + boxHeight)
        ...
        canvas.drawText(invoice.storeName, endX, y - 10f, sigNamePaint)
        canvas.drawText("Authorized Signatory", endX, y + 2f, sigTitlePaint)
